...
from .views.admin import status, index, login, login_staff, logout
...
urlpatterns = [
    ...
    path('admin/status', status, name='status'),
    ...
    path('admin/nginx/authenticate_staff',
         authenticate_staff, name='authenticate_staff'),
